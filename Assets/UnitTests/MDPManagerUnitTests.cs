...
namespace UnitTests
{
    ...
    public class MdpGenerationTests
    {
        ...
        public void TestGridWorldRules()
        {
            ...
            Assert.That((MdpRules.DrunkBonanza.GetProbabilityDistributionOfActionOutcomes().Sum()), Is.EqualTo(1f).Within(1e-10f));
        }
    ...
    public class AlgorithmsTests
    {
        ...
        public void PolicyEvaluationTest()
        {
            ...
            // Assert.AreEqual(0.908, valueFunction.Value(9),1e-4);
            // Assert.AreEqual(0.958, valueFunction.Value(10),1e-4);
